...
import (
	...
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/filesystem"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/package_stemcell/config"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/package_stemcell/ovftool"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/templates"
)
