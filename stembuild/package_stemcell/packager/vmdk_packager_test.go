...
import (
	...
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/colorlogger"
	mockfilesystem "github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/filesystem/mock"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/package_stemcell/config"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/package_stemcell/packager"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/test/helpers"
)
