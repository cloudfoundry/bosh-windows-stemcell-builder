...
import (
	...
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/assets"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/commandparser"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/construct"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/iaas_cli/iaas_clients/vcenter_manager"
	"github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/package_stemcell/packager"
