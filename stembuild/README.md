...
## Installation
Download the latest stembuild from the [Releases Page](https://github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild/releases) that corresponds to the operating system of your local host and the stemcell version that you want to build
...
```
git clone https://github.gwd.broadcom.net/TNZ/bosh-windows-stemcell-builder/stembuild.git
cd stembuild
```
